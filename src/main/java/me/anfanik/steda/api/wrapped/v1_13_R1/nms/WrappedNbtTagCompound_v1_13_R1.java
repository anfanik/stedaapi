...
public class WrappedNbtTagCompound_v1_13_R1 implements WrappedNbtTagCompound {

    public WrappedNbtTagCompound generate(NBTTagCompound tagCompound) {
        if (tagCompound == null) {
            tagCompound = new NBTTagCompound();
        }
        return new WrappedNbtTagCompound_v1_13_R1(tagCompound);
    }

    @Getter
    private final NBTTagCompound handle;

    public WrappedNbtTagCompound_v1_13_R1() {
        handle = null;
    }

    public WrappedNbtTagCompound_v1_13_R1(NBTTagCompound handle) {
        this.handle = handle;
    }
