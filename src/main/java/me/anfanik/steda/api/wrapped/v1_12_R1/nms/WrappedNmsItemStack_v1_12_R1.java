...
public class WrappedNmsItemStack_v1_12_R1 implements WrappedNmsItemStack {
    ...
    public WrappedNmsItemStack_v1_12_R1() {
        handle = null;
    }

    public WrappedNmsItemStack_v1_12_R1(ItemStack handle) {
        this.handle = handle;
    }

    @Override
    public WrappedNbtTagCompound getTag() {
        return ((WrappedNbtTagCompound_v1_12_R1) WrappedNbtTagCompound.get(MinecraftVersion.v1_12_R1)).generate(handle.getTag());
    }

    @Override
    public void setTag(WrappedNbtTagCompound tagCompound) {
        handle.setTag(((WrappedNbtTagCompound_v1_12_R1) tagCompound).getHandle());
    }
