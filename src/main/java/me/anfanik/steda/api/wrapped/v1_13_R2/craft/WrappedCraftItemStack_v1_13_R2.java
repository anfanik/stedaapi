package me.anfanik.steda.api.wrapped.v1_13_R2.craft;
...
public class WrappedCraftItemStack_v1_13_R2 implements WrappedCraftItemStack {

    public WrappedCraftItemStack generate(ItemStack itemStack) {
        return new WrappedCraftItemStack_v1_13_R2(
    ...
    public ItemStack asBukkitCopy(WrappedNmsItemStack nmsItemStack) {
        return CraftItemStack.asBukkitCopy(
                ((WrappedNmsItemStack_v1_13_R2) nmsItemStack).getHandle()
        );
    }
    ...
    public WrappedCraftItemStack_v1_13_R2() {
        handle = null;
    }

    public WrappedCraftItemStack_v1_13_R2(CraftItemStack handle) {
        this.handle = handle;
    }

    @Override
    public WrappedNmsItemStack asNmsCopy() {
        return ((WrappedNmsItemStack_v1_13_R2) WrappedNmsItemStack.get(MinecraftVersion.v1_13_R2)).generate(handle);
    }
