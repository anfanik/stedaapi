package me.anfanik.steda.api.wrapped.v1_8_R3.craft;
...
public class WrappedCraftItemStack_v1_8_R3 implements WrappedCraftItemStack {
    ...
    public ItemStack asBukkitCopy(WrappedNmsItemStack nmsItemStack) {
        return CraftItemStack.asBukkitCopy(
                ((WrappedNmsItemStack_v1_8_R3) nmsItemStack).getHandle()
        );
    }
    ...
    public WrappedCraftItemStack_v1_8_R3() {
        handle = null;
    }

    public WrappedCraftItemStack_v1_8_R3(CraftItemStack handle) {
        this.handle = handle;
    }

    @Override
    public WrappedNmsItemStack asNmsCopy() {
        return ((WrappedNmsItemStack_v1_8_R3) WrappedNmsItemStack.get(MinecraftVersion.v1_8_R3)).generate(handle);
    }
