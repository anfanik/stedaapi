...
public class WrappedNbtTagCompound_v1_16_R2 implements WrappedNbtTagCompound {

    public WrappedNbtTagCompound generate(NBTTagCompound tagCompound) {
        if (tagCompound == null) {
            tagCompound = new NBTTagCompound();
        }
        return new WrappedNbtTagCompound_v1_16_R2(tagCompound);
    }

    @Getter
    private final NBTTagCompound handle;

    public WrappedNbtTagCompound_v1_16_R2() {
        handle = null;
    }

    public WrappedNbtTagCompound_v1_16_R2(NBTTagCompound handle) {
        this.handle = handle;
    }
