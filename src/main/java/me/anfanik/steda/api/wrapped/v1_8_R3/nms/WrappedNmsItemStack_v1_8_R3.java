package me.anfanik.steda.api.wrapped.v1_8_R3.nms;
...
public class WrappedNmsItemStack_v1_8_R3 implements WrappedNmsItemStack {
    ...
    public WrappedNmsItemStack_v1_8_R3() {
        handle = null;
    }

    public WrappedNmsItemStack_v1_8_R3(ItemStack handle) {
        this.handle = handle;
    }

    @Override
    public WrappedNbtTagCompound getTag() {
        return ((WrappedNbtTagCompound_v1_8_R3) WrappedNbtTagCompound.get(MinecraftVersion.v1_8_R3)).generate(handle.getTag());
    }

    @Override
    public void setTag(WrappedNbtTagCompound tagCompound) {
        handle.setTag(((WrappedNbtTagCompound_v1_8_R3) tagCompound).getHandle());
    }
